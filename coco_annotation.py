...
if __name__ == '__main__':
    ...
    #   输出的json文件保存的位置
    #------------------------------------#
    Json_output_dir = "data/annotations"
    ...
    #   设定输出json文件的名称
    #------------------------------------#
    train_out_img_file = osp.join(Img_output_dir, 'train')
    val_out_img_file = osp.join(Img_output_dir, 'val')
    test_out_img_file = osp.join(Img_output_dir, 'test')
    ...
    out_img_files_list = [train_out_img_file, val_out_img_file, test_out_img_file]
    data_list           = [
        dict(
            #------------------------------------#
            #   基础信息
    ...
    for label_files_index, label_files in enumerate(label_files_list):
        ...
        for image_id, label_file in enumerate(label_files):
            ...
            out_img_file    = osp.join(out_img_files_list[label_files_index], base + '.jpg')
